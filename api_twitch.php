...
class TwitchChannel {
    ...
    private function ReadXML() {
        try {
            ...
            $this->isFeatured = (string) $stream->featured;
            $this->UpTime = (string) $stream->up_time;
            $this->Format = (string) $stream->format;
            $this->StreamType = (string) $stream->stream_type;
            ...
            $this->AllViewerCount = (string) $channel->views_count;
